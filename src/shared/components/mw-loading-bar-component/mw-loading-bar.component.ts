...
export class MwLoadingBarComponent implements OnInit, OnDestroy {
    ...
    constructor(@Optional() private loadingBarService: MwLoadingBarService) {
    }
